      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => modelController.reloadModel(),
          ...
          children: [
            ...
            Obx(() => Container(
              ...
              decoration: BoxDecoration(
                color: _getStatusColor(modelController.modelStatus.value),
                borderRadius: BorderRadius.circular(12.r),
                border: Border.all(color: _getStatusBorderColor(modelController.modelStatus.value)),
              ),
              child: Row(
                children: [
                  Icon(
                    _getStatusIcon(modelController.modelStatus.value),
                    color: _getStatusIconColor(modelController.modelStatus.value),
                    size: 20.sp,
                  ),
                  SizedBox(width: 12.w),
                  Expanded(
                    child: Text(
                      'Model: ${modelController.modelStatus.value}',
                      style: GoogleFonts.poppins(
                        fontSize: 14.sp,
                        fontWeight: FontWeight.w500,
                        color: _getStatusTextColor(modelController.modelStatus.value),
                      ),
                    ),
                  ),
                ],
              ...
              children: [
                Expanded(
                  child: GestureDetector(
                    onTap: () => modelController.pickImage(ImageSource.camera),
                    child: Container(
                ...
                Expanded(
                  child: GestureDetector(
                    onTap: () => modelController.pickImage(ImageSource.gallery),
                    child: Container(
                      padding: EdgeInsets.symmetric(vertical: 16.h),
                      decoration: BoxDecoration(
            ...
            // Loading State
            Obx(() {
              if (modelController.isModelLoading.value) {
                return Container(
                  padding: EdgeInsets.symmetric(vertical: 16.h),
                  child: Column(
                    children: [
              ...
              // Error State for non-mango images
              if (modelController.hasError.value) {
                return Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 12.h),
                      Text(
                        modelController.errorMessage.value,
                        style: GoogleFonts.poppins(
                          fontSize: 14.sp,
                          color: Colors.red[700],
                        ),
                        ...
                        children: [
                          Expanded(
                            child: ElevatedButton(
                              onPressed: () => modelController.clearImageAndReset(),
                          ...
                          Expanded(
                            child: ElevatedButton(
                              onPressed: () => modelController.retryClassification(),
                              style: ElevatedButton.styleFrom(
